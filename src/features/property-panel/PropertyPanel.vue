...
import CanvasConfigPanel from '../canvas/components/CanvasConfigPanel.vue'
import BasicPropertiesTab from './tabs/BasicPropertiesTab.vue'
import DataPropertiesTab from './tabs/DataPropertiesTab.vue'
import EdgePropertiesTab from './tabs/EdgePropertiesTab.vue'
...
<style scoped>
@import '../../shared/styles/components/PropertyPanel.css';
</style>